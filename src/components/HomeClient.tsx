...
const testimonials = [
  {
    ...
    themeBg: "bg-[#005eb8]",
    activeBtnBg: "bg-[#F5C842]",
    activeBtnText: "text-[#0a0a0a]",
    accentColor: "text-[#F5C842]",
    barColor: "bg-[#F5C842]",
    scriptColor: "text-[#F5C842]",
  ...
  },
  {
    ...
    themeBg: "bg-[#0a0a0a]",
    activeBtnBg: "bg-[#B5330E]",
    activeBtnText: "text-white",
    accentColor: "text-[#B5330E]",
    barColor: "bg-[#B5330E]",
    scriptColor: "text-[#B5330E]",
...
const faqs = [
  {
    ...
    answer: (
      <>
        Every project is different, so we don't do one-size-fits-all pricing. We'll talk through what you need and put together a <span className="text-[#F5C842] font-bold">custom proposal</span> that fits your goals and budget.
      </>
    ),
    related: [
  ...
  },
  {
    ...
    answer: (
      <>
        Most builds ship in <span className="text-[#F5C842] font-bold">3 to 6 weeks</span>. A custom landing page can be live in a week. Full e-commerce builds run 5 to 8 weeks. We send a <span className="text-[#F5C842] font-bold">fixed timeline</span> with the proposal — no scope creep, no surprises.
      </>
    ),
    related: [
  ...
  },
  {
    ...
    answer: (
      <>
        Yes — most of our clients are <span className="text-[#F5C842] font-bold">small or family-owned</span>. We've worked with roofers, lawyers, AV companies, restaurants, churches, and accountants. If you're a local or regional business looking for real growth, you're the kind of client we built this agency for.
      </>
    ),
    related: [
      { text: "How does pricing work?", index: 0 },
  ...
  },
  {
    ...
    answer: (
      <>
        <span className="text-[#F5C842] font-bold">Villa Rica, GA</span> — about 35 miles west of Atlanta. We ride for clients across the Southeast. Currently serving Villa Rica, Carrollton, Douglasville, Cleveland TN, Franklin TN, and beyond. Distance is no issue; results are.
      </>
    ),
    related: [
      { text: "How do I get started?", index: 5 }
  ...
  },
  {
    ...
    answer: (
      <>
        Results vary by business and starting point, but the goal we work toward on every engagement is the same: traffic that costs less than the revenue it brings in. Most of our long-term clients see traffic, lead volume, and revenue grow within <span className="text-[#F5C842] font-bold">the first 90 days</span>. We send monthly reports so you can see the math yourself.
      </>
    ),
    related: [
...
export default function HomeClient() {
  ...
  return (
    <div className={`${anton.variable} bg-[#F2EBDA] text-[#0a0a0a] font-inter selection:bg-[#B5330E] selection:text-[#F2EBDA] min-h-screen relative overflow-hidden flex flex-col md:pt-[36px] pt-0`}>
      ...
      <header className="relative w-full bg-[#0a0a0a] border-b-4 border-[#0a0a0a] py-4 px-6 md:px-12 z-40">
        <div className="w-full flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center gap-8 font-inter text-sm md:text-base font-bold uppercase tracking-wider text-[#F2EBDA]">
            <a href="#case-studies" className="hover:text-[#B5330E] transition-colors duration-200">Case Studies</a>
            <a href="#services" className="hover:text-[#B5330E] transition-colors duration-200">Services</a>
            <a href="#portfolio" className="hover:text-[#B5330E] transition-colors duration-200">Selected Works</a>
          </nav>
 
          {/* Right Action Button & Mobile Trigger */}
          <div className="flex items-center gap-4">
            <button 
              onClick={() => openProposalModal("header_cta")}
        ...
        {mobileMenuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-[#0a0a0a] border-b-4 border-[#0a0a0a] py-4 px-6 flex flex-col gap-4 font-inter text-base font-bold uppercase tracking-wider text-[#F2EBDA] z-50">
            <a 
              ...
              className="hover:text-[#B5330E] transition-colors duration-200"
            >
              Case Studies
            </a>
            <a 
            ...
            <button 
              onClick={() => {
                ...
                openProposalModal("mobile_header_cta");
              }}
              className="h3-btn-brutalist border-[#F2EBDA] bg-[#B5330E] text-white font-bold px-4 py-2.5 uppercase tracking-wider text-xs inline-flex items-center justify-center gap-1.5 mt-2 shadow-[3px_3px_0px_#f3efe0] hover:shadow-[4px_4px_0px_#f3efe0] cursor-pointer text-center"
            >
      ...
      <section className="relative w-full py-16 md:py-24 px-6 md:px-12 z-10 flex-grow flex items-center">
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6 text-left">
            ...
            <h1 className="font-anton text-4xl sm:text-6xl md:text-8xl leading-[0.9] text-[#0a0a0a] uppercase tracking-tight h3-animate-fade-in-up">
              DIGITAL <br className="hidden md:inline" />
              MARKETING <br />
              THAT <span className="text-[#B5330E]">DRIVES</span> <br className="hidden md:inline" />
              RESULTS.
            </h1>

            <p className="font-inter text-lg md:text-xl text-[#0a0a0a]/80 max-w-xl leading-relaxed h3-animate-fade-in-up h3-delay-1">
            ...
            <div className="flex flex-wrap gap-4 mt-2 h3-animate-fade-in-up h3-delay-2">
              <button 
                onClick={() => openProposalModal("hero_primary_cta")}
              ...
              <a href="#services" className="h3-btn-brutalist bg-[#F2EBDA] text-[#0a0a0a] font-bold px-8 py-4 uppercase tracking-wider text-sm">
                Explore Services
              </a>
            </div>

            {/* Performance Stats Strip */}
            <div className="grid grid-cols-3 gap-4 border-t-2 border-[#0a0a0a]/20 pt-8 mt-4 h3-animate-fade-in-up h3-delay-3">
              <div>
                <span className="font-anton text-3xl sm:text-4xl text-[#005eb8] block">300% ↑</span>
                <span className="text-[10px] md:text-xs font-bold uppercase tracking-wider text-[#0a0a0a]/60">Avg Site Traffic</span>
              </div>
              <div>
                <span className="font-anton text-3xl sm:text-4xl text-[#008f4c] block">90-DAY</span>
                <span className="text-[10px] md:text-xs font-bold uppercase tracking-wider text-[#0a0a0a]/60">Payback Target</span>
              </div>
              <div>
                <span className="font-anton text-3xl sm:text-4xl text-[#B5330E] block">100+</span>
                <span className="text-[10px] md:text-xs font-bold uppercase tracking-wider text-[#0a0a0a]/60">Brands Shipped</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 flex justify-center items-center relative">
            <div className="h3-brutalist-card bg-[#B5330E] p-8 text-[#F2EBDA] h3-animate-slide-in-right w-full max-w-[420px] flex flex-col justify-between aspect-[3/4] relative overflow-hidden shadow-2xl">
              <div className="absolute top-0 right-0 w-24 h-24 bg-black/20 rounded-full blur-xl pointer-events-none" />
              ...
              <div className="my-8 flex flex-col gap-2">
                <span className="font-inter text-xs uppercase tracking-widest font-bold text-[#F5C842]">Our Mission</span>
        ...
        <div className="h3-marquee-track">
          {[1, 2, 3, 4].map((index) => (
            <div key={index} className="flex gap-16 items-center pr-16 font-anton text-2xl md:text-3xl uppercase tracking-widest select-none whitespace-nowrap">
              ...
              <span className="text-[#005eb8]">★</span>
              <span>EMAIL + CRM</span>
              <span className="text-[#F2EBDA]">★</span>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="case-studies" className="w-full py-12 md:py-20 px-6 md:px-12 bg-[#F2EBDA] z-10 border-b-4 border-[#0a0a0a]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4 flex flex-col gap-6">
            <div className="h3-reveal-on-scroll flex flex-col gap-2">
              ...
              <h2 className="font-anton text-5xl md:text-6xl uppercase leading-none">CASE<br />STUDIES</h2>
              <div className="h-1.5 w-16 bg-[#B5330E] mt-2" />
            </div>

            <p className="font-inter text-sm md:text-base text-[#0a0a0a]/70 leading-relaxed max-w-sm">
            ...
            <div className="hidden md:flex h3-reveal-on-scroll h3-brutalist-card bg-[#B5330E] text-[#F2EBDA] p-8 flex-col justify-between aspect-square mt-4 -rotate-2 select-none">
              <span className="font-inter text-xs uppercase tracking-widest font-bold">Creative Cowboys</span>
              <h3 className="font-anton text-6xl md:text-7xl -rotate-6 uppercase text-center my-auto leading-none text-[#F5C842]">
                NO<br />FLUFF
              </h3>
              <span className="font-inter text-[10px] uppercase tracking-widest font-bold text-right">RESULTS ONLY</span>
            </div>
          </div>
          ...
          <div className="lg:col-span-8 flex flex-col gap-6">
            {caseStudies.map((study, idx) => (
              <div 
                key={study.id}
                className="h3-reveal-on-scroll h3-brutalist-card bg-[#F2EBDA] hover:bg-[#F2EBDA]/50 p-6 md:p-8 flex flex-col gap-6"
              >
                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                  <div className="flex-1">
                    ...
                    <h3 className="font-anton text-2xl md:text-3xl uppercase tracking-wide leading-tight">
                      {study.title}
                    </h3>
      ...
      <section id="services" className="w-full py-12 md:py-20 px-6 md:px-12 bg-[#0a0a0a] border-b-4 border-[#0a0a0a] z-10 text-white">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Header row */}
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 pb-8 border-b border-[#F2EBDA]/10">
            <div className="h3-reveal-on-scroll flex flex-col text-left">
              ...
              <h2 className="font-anton text-5xl md:text-6xl text-white uppercase mt-1 leading-none">SERVICES.</h2>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4 mt-8 h3-reveal-on-scroll">
            {services.map((item) => (
              <a 
                key={item.num}
                href={item.link}
                className="flex flex-col group py-5 border-b border-[#F2EBDA]/10 hover:border-[#F5C842]/50 transition-colors duration-200"
              >
                <div className="flex items-baseline justify-between w-full">
                  <div className="flex items-baseline gap-4 md:gap-6">
                    <span className="font-anton text-4xl md:text-5xl text-[#F5C842] select-none leading-none min-w-[50px] text-left">
                      {item.num}
                    </span>
                    <span className="font-anton text-lg sm:text-xl md:text-2xl text-white uppercase tracking-wide leading-none group-hover:text-[#F5C842] transition-colors duration-150">
                      {item.title}
                    </span>
                  </div>
                  <ArrowUpRight className="w-5 h-5 text-[#F5C842] group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-transform duration-150" />
                </div>
                
                <div className="pl-[66px] md:pl-[74px] mt-2 text-left">
                  <span className="text-[#F2EBDA]/60 text-xs md:text-sm font-inter font-bold tracking-wide">
                    {item.desc}
                  </span>
                </div>
              </a>
          ...
          {/* Custom CTA Box */}
          <div className="h3-reveal-on-scroll border-4 border-[#0a0a0a] bg-[#F2EBDA] text-[#0a0a0a] p-6 md:p-8 flex flex-col justify-between sm:flex-row sm:items-center gap-6 mt-16 shadow-[6px_6px_0px_#e94e33]">
            <div className="flex flex-col gap-2 text-left">
              <h3 className="font-anton text-2xl text-[#B5330E] uppercase tracking-widest leading-none">NEED A CUSTOM MARKETING BUILD?</h3>
              <p className="font-inter text-sm text-[#0a0a0a]/80 max-w-2xl leading-relaxed mt-2">
            ...
            <button 
              onClick={() => openProposalModal("custom_build_cta")}
              className="h3-btn-brutalist bg-[#0a0a0a] text-[#F2EBDA] font-bold px-8 py-3.5 uppercase tracking-wider text-xs w-fit flex-shrink-0 border-[#0a0a0a] cursor-pointer"
            >
              GET A PROPOSAL
            </button>
          </div>
      ...
      <section id="portfolio" className="w-full py-12 md:py-20 px-6 md:px-12 bg-[#F2EBDA] border-b-4 border-[#0a0a0a] z-10">
        <div className="max-w-7xl mx-auto">
          
          <div className="h3-reveal-on-scroll flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
            <div>
              <span className="text-[#008f4c] font-bold text-xs uppercase tracking-widest">Selected Works</span>
              <h2 className="font-anton text-5xl md:text-6xl uppercase leading-none mt-1">PORTFOLIO</h2>
              <div className="h-1.5 w-16 bg-[#008f4c] mt-2" />
            </div>
            <p className="font-inter text-sm md:text-base text-[#0a0a0a]/60 max-w-md">
                ...
                <div className={`h3-flip-card-inner ${flippedCards[idx] ? "flipped" : ""}`}>
                  ...
                  <div className={`h3-flip-card-front ${item.bgClass} p-6`}>
                    ...
                    <div className="flex flex-col gap-1.5 mt-auto w-full text-left">
                      <h3 className="font-anton text-2xl uppercase tracking-wider leading-none">
                        {item.title}
                      </h3>
                      <p className="font-inter text-xs opacity-75 leading-normal">
                        {item.desc}
                      </p>
                    </div>
                  </div>
                  ...
                  {/* Card Back */}
                  <div className="h3-flip-card-back bg-[#0a0a0a] text-[#F2EBDA] p-6">
                    {/* Services bullet list */}
                    <ul className="flex flex-col gap-3 my-auto w-full text-left">
                      {item.services.map((svc, sIdx) => (
                        <li key={sIdx} className="flex items-center gap-2 font-inter font-bold text-xs uppercase tracking-wide text-[#F2EBDA]/90">
                          <span className="w-1.5 h-1.5 bg-[#B5330E] rotate-45 flex-shrink-0" />
                          <span>{svc}</span>
                        </li>
                      ))}
                    </ul>

                    <div className="flex justify-between items-center w-full border-t border-[#F2EBDA]/15 pt-2 text-[10px] font-bold uppercase tracking-widest text-[#F2EBDA]/70">
      ...
      <section 
        ...
        className={`w-full py-12 md:py-20 px-6 md:px-12 border-b-4 border-[#0a0a0a] z-10 relative flex flex-col items-center justify-between transition-colors duration-500 overflow-hidden ${testimonials[activeTestimonial].themeBg}`}
      >
        <div className="max-w-7xl mx-auto w-full flex flex-col justify-between h-full min-h-[980px] sm:min-h-[850px] lg:min-h-[750px] relative z-10">
          ...
          {/* Top Header Row */}
          <div className="w-full flex items-center justify-between font-inter text-xs md:text-sm font-bold tracking-widest text-white/95 uppercase border-b border-white/20 pb-4 mb-12">
          ...
          <div className={`grid grid-cols-1 lg:grid-cols-12 gap-12 items-center transition-opacity duration-200 ${isTransitioning ? 'opacity-0' : 'opacity-100'}`}>
            ...
            <div className="lg:col-span-7 flex flex-col items-start text-left gap-4 min-h-[480px] sm:min-h-[380px] lg:min-h-[480px] xl:min-h-[420px]">
              ...
              <div className="flex gap-3">
                <span className="bg-black/30 backdrop-blur-sm border border-white/10 text-white font-inter font-bold text-xs tracking-wider px-3 py-1 rounded">
                  {testimonials[activeTestimonial].tag}
                </span>
              </div>

              {/* Large Client Name */}
              <h2 className={`font-anton text-3xl sm:text-5xl md:text-7xl leading-none mt-2 select-none uppercase tracking-tight ${testimonials[activeTestimonial].accentColor}`}>
                {testimonials[activeTestimonial].name}
              </h2>

              {/* Subtitle */}
              <p className="font-inter font-bold text-xs tracking-widest text-white/90 uppercase">
              ...
              {/* Attribution */}
              <p className="font-inter font-bold text-sm tracking-widest text-[#F5C842] uppercase mt-2">
                {testimonials[activeTestimonial].attribution}
              </p>

              {/* 5 Stars */}
              <div className="flex gap-1.5 mt-2 text-[#F5C842]">
                {[...Array(5)].map((_, i) => (
          ...
          <div className="w-full flex flex-col sm:flex-row items-center justify-between gap-6 border-t border-white/20 pt-8 mt-12">
            ...
            <div className="flex items-center gap-4">
              ...
              <button 
                onClick={nextSlide}
                className={`rounded-xl w-14 h-12 flex items-center justify-center transition-colors cursor-pointer font-bold select-none text-[#0a0a0a] ${testimonials[activeTestimonial].activeBtnBg}`}
              ...
              {testimonials.map((item, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className={`text-[9px] font-bold font-inter tracking-widest uppercase transition-colors duration-200 ${
      ...
      <section className="w-full py-12 md:py-20 px-6 md:px-12 bg-[#F2EBDA] border-b-4 border-[#0a0a0a] z-10 text-[#0a0a0a]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="h3-reveal-on-scroll text-left flex flex-col gap-2 mb-12">
            ...
            <h2 className="font-anton text-5xl md:text-6xl text-[#0a0a0a] uppercase mt-1 leading-none">COMMON QUESTIONS.</h2>
          </div>
                ...
                return (
                  <div key={index} className="h3-reveal-on-scroll flex flex-col w-full">
                    ...
                    >
                      ...
                      <span className={`text-lg md:text-xl font-bold flex-shrink-0 ml-4 ${isActive ? "text-[#F5C842]" : "text-[#B5330E]"}`}>
                        {isActive ? "—" : "+"}
                      </span>
                    </button>
                    ...
                    {isActive && (
                      <div className="lg:hidden w-full mt-3">
                        <div className="bg-[#B5330E] border-4 border-[#0a0a0a] p-6 text-white shadow-[4px_4px_0px_#1a1a1a] flex flex-col justify-between">
                          <div>
                            <span className="text-[#F5C842] font-bold text-[10px] md:text-xs uppercase tracking-widest font-inter">
                              Q.{faq.index} · {faq.category}
                            </span>
                            <h3 className="font-anton text-2xl text-white uppercase mt-2 leading-tight">
                              {faq.question}
                            </h3>
                            <div className="font-inter text-sm md:text-base text-[#F2EBDA]/90 leading-relaxed mt-4 text-left">
                              {faq.answer}
                            </div>
                          </div>
                          ...
                          {faq.related && faq.related.length > 0 && (
                            <div className="w-full mt-6 pt-4 border-t border-h3-cream/20">
                              <span className="text-[#F5C842] font-bold text-[10px] md:text-xs uppercase tracking-widest font-inter block mb-2">
                                RELATED
                              </span>
                              <div className="flex flex-col gap-2">
                                {faq.related.map((rel, rIdx) => (
                                  <button
                                    ...
                                    className="flex items-center gap-2 text-white font-inter font-bold text-xs md:text-sm uppercase tracking-wide text-left hover:text-[#F5C842] transition-colors"
                                  >
                                    <span>→</span>
                                    <span className="underline decoration-[#F2EBDA]/30">{rel.text}</span>
                                  </button>
                                ))}
                              </div>
                            </div>
              ...
              {(() => {
                ...
                return (
                  <div className="bg-[#B5330E] border-4 border-[#0a0a0a] p-8 text-white shadow-[6px_6px_0px_#1a1a1a] min-h-[360px] flex flex-col justify-between">
                    <div>
                      <span className="text-[#F5C842] font-bold text-xs uppercase tracking-widest font-inter">
                        Q.{currentFaq.index} · {currentFaq.category}
                      </span>
                      <h3 className="font-anton text-4xl text-white uppercase mt-2 leading-tight">
                        {currentFaq.question}
                      </h3>
                      <div className="font-inter text-base md:text-lg text-[#F2EBDA]/90 leading-relaxed mt-6 text-left">
                        {currentFaq.answer}
                      </div>
                    </div>

                    {currentFaq.related && currentFaq.related.length > 0 && (
                      <div className="w-full mt-8 pt-6 border-t border-[#F2EBDA]/20">
                        <span className="text-[#F5C842] font-bold text-xs uppercase tracking-widest font-inter block mb-3">
                          RELATED
                        </span>
                        <div className="flex flex-col gap-2.5">
                          {currentFaq.related.map((rel, rIdx) => (
                            <button
                              key={rIdx}
                              onClick={() => setActiveFaq(rel.index)}
                              className="flex items-center gap-2 text-white font-inter font-bold text-sm md:text-base uppercase tracking-wide text-left hover:text-[#F5C842] transition-colors cursor-pointer"
                            >
                              <span>→</span>
                              <span className="underline decoration-[#F2EBDA]/30 hover:decoration-[#F5C842]">{rel.text}</span>
                            </button>
                          ))}
                        </div>
                      </div>
      ...
      <footer id="contact" className="w-full bg-[#0a0a0a] text-[#F2EBDA] border-t-4 border-[#0a0a0a] py-12 md:py-16 px-6 md:px-12 relative z-20">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 items-start">
          ...
          <div className="md:col-span-4 flex flex-col items-center justify-center py-6 md:pt-0 md:pb-6 border-y-2 md:border-y-0 md:border-x-2 border-[#F2EBDA]/10">
            <div className="font-anton text-3xl uppercase tracking-widest text-[#B5330E] mb-2">
              COWBOYS
            </div>
            <div className="font-inter text-[9px] uppercase tracking-[0.2em] font-bold text-[#F2EBDA]/40">
              © 2026 ALL RIGHTS RESERVED
            </div>
            
            {/* Social Icons Badge Grid */}
            <div className="flex gap-4 mt-6">
              <a href="https://www.facebook.com/creativecowboys" target="_blank" rel="noopener noreferrer" className="w-8 h-8 border border-[#F2EBDA] rotate-45 flex items-center justify-center hover:bg-[#F2EBDA] hover:text-[#0a0a0a] transition-colors duration-200 group">
          ...
          <div className="md:col-span-3 flex flex-col gap-6 text-left">
            ...
            <div className="flex flex-col gap-2 font-bold text-xs uppercase tracking-widest text-[#F2EBDA]/70">
              <a href="/seo" className="hover:text-[#B5330E] transition-colors">SEO Programs</a>
              <a href="/web-design" className="hover:text-[#B5330E] transition-colors">Web Design</a>
