  ...
  const steps = [
    {
      ...
      title: "Discovery",
      timing: "Week 1",
      icon: "/franklin-tn/process-1.svg",
    ...
    },
    {
      ...
      title: "Design",
      timing: "Weeks 2–3",
      icon: "/franklin-tn/process-2.svg",
    ...
    },
    {
      ...
      title: "Build",
      timing: "Weeks 3–5",
      icon: "/franklin-tn/process-3.svg",
    ...
    },
    {
      ...
      title: "Launch",
      timing: "Week 5–6",
      icon: "/franklin-tn/process-4.svg",
    ...
    },
    {
      ...
      title: "Optimize",
      timing: "Months 2–3",
      icon: "/franklin-tn/process-5.svg",
    ...
    <section className="bg-white py-32">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="hidden lg:block relative mt-16">
          ...
          <div className="absolute top-16 left-[10%] right-[10%] h-0.5 bg-neutral-200 z-0"></div>

          <div className="grid grid-cols-5 gap-6 relative z-10">
            {steps.map((step, i) => (
              <div key={i} className="flex flex-col items-center text-center group">
                {/* Step circle indicator with number */}
                <div className="w-10 h-10 rounded-full border-2 border-white bg-white shadow-sm flex items-center justify-center font-display font-bold text-lg text-[#F26522] mb-6 z-10 transition-transform duration-300 group-hover:scale-110">
                  {step.num}
                </div>

                {/* SVG Icon */}
                <div className="w-16 h-16 bg-[#F4F2F0] rounded-2xl flex items-center justify-center p-3 mb-6 select-none transition-shadow duration-300 hover:shadow-sm">
                  <Image 
                    src={step.icon} 
                    alt={step.title} 
                    width={48} 
                ...
                {/* Step Metadata */}
                <h3 className="font-display font-bold text-lg text-[#121417] mb-1">
                  {step.title}
                </h3>
                <span className="text-xs font-bold text-[#F26522] bg-[#F26522]/10 px-2.5 py-0.5 rounded-full mb-4">
                  {step.timing}
                </span>

                {/* Step Paragraph */}
                <p className="font-body text-sm text-neutral-600 leading-relaxed max-w-[220px]">
                  {step.desc}
                </p>
              </div>
            ))}
        ...
        <div className="block lg:hidden relative pl-8 before:absolute before:inset-y-0 before:left-3.5 before:w-0.5 before:bg-neutral-200">
          <div className="space-y-12">
            {steps.map((step, i) => (
              <div key={i} className="relative flex flex-col sm:flex-row gap-6 items-start">
                {/* Number indicator */}
                <div className="absolute -left-8 top-1.5 w-7 h-7 rounded-full border-2 border-white bg-white shadow-sm flex items-center justify-center font-display font-bold text-sm text-[#F26522] z-10">
                  {step.num}
                </div>

                {/* Icon box */}
                <div className="w-14 h-14 bg-[#F4F2F0] rounded-xl flex items-center justify-center p-2.5 shrink-0 select-none">
                  <Image 
                    src={step.icon} 
                    alt={step.title} 
                    width={40} 
                ...
                {/* Content card */}
                <div className="flex-1 bg-[#F4F2F0] p-6 rounded-2xl">
                  <div className="flex items-center justify-between mb-3 flex-wrap gap-2">
                    <h3 className="font-display font-bold text-lg text-[#121417]">
                      {step.title}
                    </h3>
                    <span className="text-xs font-bold text-[#F26522] bg-[#F26522]/10 px-2.5 py-0.5 rounded-full">
                      {step.timing}
                    </span>
                  </div>
