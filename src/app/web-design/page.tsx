    ...
    return (
      ...
      `}</style>
            ...
            <div style={{ background: DARK, minHeight: "100vh", color: "#d1d5db", fontFamily: "var(--font-geist-sans, sans-serif)" }}>
                ...
                <section style={{ background: CARD, borderTop: "1px solid rgba(255,255,255,0.05)", borderBottom: "1px solid rgba(255,255,255,0.05)", padding: "96px 24px", position: "relative", overflow: "hidden" }}>
                    <div style={{ position: "absolute", top: 0, left: "50%", transform: "translateX(-50%)", width: "700px", height: "350px", background: "rgba(241,95,42,0.08)", filter: "blur(100px)", borderRadius: "50%", pointerEvents: "none" }} />
                    <div style={{ maxWidth: "1060px", margin: "0 auto", position: "relative", zIndex: 1 }}>
                        <div style={{ textAlign: "center", marginBottom: "64px" }}>
                            <h2 style={{ fontSize: "clamp(28px, 4.5vw, 50px)", fontWeight: 800, letterSpacing: "-0.03em", color: "#fff", margin: "0 0 18px" }}>
                                Strategy First. Design Second.
                            </h2>
                            <p style={{ fontSize: "17px", color: "rgba(255,255,255,0.45)", maxWidth: "560px", marginInline: "auto", lineHeight: 1.7 }}>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "32px" }}>
                            {[
                                ...
                                <div key={step} style={{ position: "relative" }}>
                                    <p style={{ fontSize: "60px", fontWeight: 900, color: "rgba(255,255,255,0.04)", lineHeight: 1, margin: "0 0 12px" }}>{step}</p>
                                    <h3 style={{ fontSize: "16px", fontWeight: 700, color: "#fff", margin: "0 0 10px" }}>{title}</h3>
                                    <p style={{ fontSize: "14px", lineHeight: 1.75, color: "rgba(255,255,255,0.42)", margin: 0 }}>{desc}</p>
                                </div>
                            ))}
                        </div>
                    </div>
