    ...
    <div className="bg-[#F2EBDA] text-[#0a0a0a] font-inter selection:bg-[#B5330E] selection:text-white min-h-screen relative overflow-hidden flex flex-col">
      ...
      <section className="hero dotgrid py-12 md:py-24 px-6 md:px-12 border-b-[2.5px] border-[#0a0a0a]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 relative w-full h-[460px] md:h-[500px]">
            ...
            <div className="absolute top-8 left-0 right-12 md:right-16 bg-white border-3 border-[#0a0a0a] shadow-[10px_10px_0px_#0a0a0a] -rotate-[1.5deg] z-10 overflow-hidden flex flex-col">
              ...
              <div className="aspect-[16/10] bg-gradient-to-br from-[#0a0a0a] to-[#2a1a15] p-5 flex flex-col justify-between text-white select-none">
                <div className="flex justify-between items-center text-[10px]">
                  ...
                  <span className="bg-[#B5330E] text-white px-2 py-0.5 text-[8px] font-anton tracking-wider uppercase">GET A QUOTE</span>
                </div>
                <div className="text-left mt-6">
                  <div className="font-anton text-[8px] text-[#B5330E] tracking-widest uppercase">CLEVELAND, TN · EST. 2014</div>
                  <div className="font-anton text-xl md:text-2xl leading-[0.88] uppercase mt-1">
                    WE MAKE<br />
                    <span className="text-[#B5330E]">PRODUCTION</span><br />
                    LEGENDARY.
                  </div>
                </div>
              </div>
            ...
            <div className="absolute bottom-4 right-0 w-28 md:w-32 bg-[#0a0a0a] rounded-[22px] p-2 rotate-[5deg] shadow-[7px_7px_0px_#B5330E] z-20 overflow-hidden">
              <div className="bg-gradient-to-br from-[#0a0a0a] to-[#2a1a15] rounded-[14px] aspect-[9/16] p-3 flex flex-col justify-between text-white select-none">
                ...
                <div className="text-left">
                  ...
                  <div className="bg-[#B5330E] text-white py-1 text-[7px] text-center font-anton tracking-wider uppercase mt-2">
                    GET A QUOTE
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 md:py-28 px-6 md:px-12 bg-[#F2EBDA]" id="why">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-left mb-12">
            <div className="font-anton text-xs text-[#B5330E] tracking-[2.5px] uppercase mb-3">— WHY CREATIVE COWBOYS —</div>
            <h2 className="font-anton text-4xl sm:text-5xl md:text-[52px] leading-[0.92] text-[#0a0a0a] uppercase max-w-xl">
              WE DON'T BUILD WEBSITES.<br />
              WE BUILD <span className="text-[#B5330E]">REVENUE MACHINES</span>.
            </h2>
            <p className="font-inter text-sm md:text-base text-[#5a5a5a] leading-relaxed max-w-xl mt-4">
              Most web designers are artists. We are marketers. Every pixel we place has one job — turn your visitors into paying customers. <span className="font-lobster text-xl md:text-2xl text-[#B5330E] inline-block rotate-[-3deg] ml-1.5">no fluff, partner</span>
            </p>
          </div>
          ...
          <div className="border-t-[2.5px] border-[#0a0a0a]">
            {[
              ...
              <div key={row.num} className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8 items-center py-8 border-b-[2.5px] border-[#0a0a0a]">
                <div className="md:col-span-1 font-anton text-4xl text-[#B5330E]">{row.num}</div>
                <div className="md:col-span-4 font-anton text-xl sm:text-2xl text-[#0a0a0a] uppercase tracking-wide">{row.title}</div>
                <div className="md:col-span-7 font-inter text-sm text-[#5a5a5a] leading-relaxed">{row.desc}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 md:py-28 px-6 md:px-12 bg-[#E8E1CF] dotgrid border-y-[2.5px] border-[#0a0a0a]" id="capabilities">
        <div className="max-w-7xl mx-auto">
          {/* Head */}
          <div className="text-left mb-12">
            <div className="font-anton text-xs text-[#B5330E] tracking-[2.5px] uppercase mb-3">— WHAT YOU GET —</div>
            <h2 className="font-anton text-4xl sm:text-5xl md:text-[52px] leading-[0.92] text-[#0a0a0a] uppercase max-w-xl">
              CUSTOM WEBSITES<br />
              BUILT FOR <span className="text-[#B5330E]">GROWTH</span>.
            </h2>
            <p className="font-inter text-sm md:text-base text-[#5a5a5a] leading-relaxed max-w-xl mt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              >
                <div className={`font-anton text-[10px] tracking-[2px] uppercase mb-3 ${card.featured ? "text-[#0a0a0a]" : "text-[#B5330E]"}`}>{card.tag}</div>
                <h3 className="font-anton text-xl sm:text-2xl text-[#0a0a0a] uppercase mb-3">{card.title}</h3>
                <p className={`font-inter text-sm leading-relaxed ${card.featured ? "text-[#0a0a0a]/80" : "text-[#5a5a5a]"}`}>{card.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 md:py-28 px-6 md:px-12 bg-[#F2EBDA] border-b-[2.5px] border-[#0a0a0a]">
        <div className="max-w-7xl mx-auto">
          {/* Head */}
          <div className="text-left mb-12">
            <div className="font-anton text-xs text-[#B5330E] tracking-[2.5px] uppercase mb-3">— PROVEN OUTCOMES —</div>
            <h2 className="font-anton text-4xl sm:text-5xl md:text-[52px] leading-[0.92] text-[#0a0a0a] uppercase">
              SITES THAT ACTUALLY <span className="text-[#B5330E]">CONVERT</span>.
            </h2>
          </div>
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="border-3 border-[#0a0a0a] bg-white shadow-[10px_10px_0px_#0a0a0a] p-8 md:p-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center text-left">
              <div className="lg:col-span-8 flex flex-col">
                ...
                <ul className="list-disc pl-5 font-inter text-sm text-[#5a5a5a] leading-relaxed space-y-2">
              ...
              <div className="lg:col-span-4 text-center border-t-2 lg:border-t-0 lg:border-l-2 border-neutral-100 pt-6 lg:pt-0 lg:pl-6">
                <div className="font-anton text-6xl md:text-7xl text-[#B5330E] leading-none">300%</div>
            ...
            <div className="border-3 border-[#0a0a0a] bg-white shadow-[10px_10px_0px_#0a0a0a] p-8 md:p-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center text-left">
              ...
              <div className="lg:col-span-4 text-center border-t-2 lg:border-t-0 lg:border-l-2 border-neutral-100 pt-6 lg:pt-0 lg:pl-6">
                <div className="font-anton text-6xl md:text-7xl text-[#B5330E] leading-none">+1000%</div>
      ...
      <section className="py-20 md:py-28 px-6 md:px-12 bg-[#0e0e0e] text-[#F2EBDA] border-b-[2.5px] border-[#0a0a0a]" id="process">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-left mb-16">
            ...
            <p className="font-inter text-sm md:text-base text-[#a0998a] leading-relaxed max-w-xl mt-4">
          ...
          <div className="relative">
            ...
            <div className="absolute top-[88px] left-[10%] right-[10%] h-[3px] bg-gradient-to-r from-[#F5C842] via-[#B5330E] to-[#F5C842] hidden lg:block z-0" />
                ...
                <div key={item.step} className="flex flex-col items-center text-center">
                  ...
                  <div className="h-20 flex items-center justify-center mb-4">
                    <div className={`rounded-full flex items-center justify-center font-anton border-4 border-[#0e0e0e] transition-all ${
                      item.featured 
                        ? "w-[70px] h-[70px] bg-[#B5330E] text-white text-2xl shadow-[0_0_0_4px_#F5C842]" 
                  ...
                  <h3 className="font-anton text-lg text-white mb-2 uppercase">{item.title}</h3>
                  <p className="font-inter text-[12px] text-[#a0998a] leading-relaxed px-4">{item.desc}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-20 md:py-28 px-6 md:px-12 bg-[#F2EBDA] dotgrid border-b-[2.5px] border-[#0a0a0a]">
        <div className="max-w-7xl mx-auto">
          {/* Head */}
          <div className="text-left mb-12">
            <div className="font-anton text-xs text-[#B5330E] tracking-[2.5px] uppercase mb-3">— WHO WE WORK WITH —</div>
            <h2 className="font-anton text-4xl sm:text-5xl md:text-[52px] leading-[0.92] text-[#0a0a0a] uppercase max-w-xl">
              BUILT FOR BUSINESSES<br />
              THAT WANT TO <span className="text-[#B5330E]">GROW</span>.
            </h2>
            <p className="font-inter text-sm md:text-base text-[#5a5a5a] leading-relaxed max-w-xl mt-4">
      ...
      <section className="py-20 md:py-28 px-6 md:px-12 bg-[#E8E1CF] border-b-[2.5px] border-[#0a0a0a]" id="faq">
        <div className="max-w-4xl mx-auto">
          {/* Head */}
          <div className="text-left mb-12">
            <div className="font-anton text-xs text-[#B5330E] tracking-[2.5px] uppercase mb-3">— FAQ —</div>
            <h2 className="font-anton text-4xl sm:text-5xl md:text-[52px] leading-[0.92] text-[#0a0a0a] uppercase">
          ...
          <div className="flex flex-col border-t-[2.5px] border-[#0a0a0a] text-left">
            <details className="faq-item" open={true}>
              ...
              <div className="font-inter text-sm md:text-base text-[#5a5a5a] leading-relaxed pb-6 max-w-2xl">
      ...
      <section className="final-cta py-24 md:py-32 px-6 md:px-12 bg-[#F2EBDA] dotgrid border-b-[2.5px] border-[#0a0a0a] text-center" id="contact">
        <div className="max-w-4xl mx-auto flex flex-col items-center">
          <div className="font-anton text-xs text-[#B5330E] tracking-[2.5px] uppercase mb-4">— READY WHEN YOU ARE —</div>
          <h2 className="font-anton text-4xl sm:text-5xl md:text-6xl leading-[0.9] text-[#0a0a0a] uppercase mb-6">
            ...
            <span className="text-[#B5330E]">CONFUSING</span> WEBSITE.
          </h2>
          <p className="font-inter text-sm md:text-base text-[#5a5a5a] leading-relaxed max-w-md mb-8">
