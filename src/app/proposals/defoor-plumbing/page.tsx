...
const SERVICES: Service[] = [
    ...
    },
    {
        ...
        tagline: "AI voice agents, chat agents & AI search optimization.",
        price: 297,
        priceLabel: "$297",
        billing: "monthly",
    ...
    // ── One-time
    {
        ...
        bullets: [
            ...
            "Business card & truck wrap design",
      ...
      `}</style>
            ...
            <div style={{ position: "relative", zIndex: 10, textAlign: "center", padding: "0 24px", maxWidth: "760px" }}>
                ...
                <p className="p4" style={{ fontSize: "clamp(15px,1.8vw,18px)", color: MUTED, lineHeight: 1.55, margin: "0 0 36px" }}>
                    West Metro Atlanta trusts DeFoor for every leak, line, and installation. Now let&rsquo;s make sure they can find you first &mdash; on Google, on social, and everywhere else that matters.
                ...
                <div className="p4" style={{ display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap" }}>
                    {[
                        { val: "West Metro", lbl: "Atlanta" },
                        { val: "Expert", lbl: "Plumbing Services" },
                        { val: "D4", lbl: "Plumbing" },
                    ].map(s => (
                        <div key={s.val} style={{
...
<table width="600" cellpadding="0" cellspacing="0" align="center" style="max-width:600px;margin:0 auto;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 40px rgba(0,0,0,0.08);">
  ...
  <tr><td style="background:linear-gradient(135deg,#1a1514 0%,#2d1f1a 100%);padding:40px 40px 36px;text-align:center;">
    ...
    <h1 style="font-size:28px;font-weight:800;color:#ffffff;margin:0 0 8px;letter-spacing:-0.03em;">DeFoor Plumbing</h1>
...
// ─── Main checkout page ────────────────────────────────────────────────────
// Package: Website ($497/mo paid) + SEO Local (free) + AI Marketing Suite (free) = $497/mo
const PACKAGE_IDS = ["website-monthly", "seo-local", "ai-marketing-suite"];
const PACKAGE_FREE_IDS = new Set(["seo-local", "ai-marketing-suite"]);

export default function DefoorPlumbingProposal() {
    const [selectedIds, setSelectedIds] = useState<Set<string>>(new Set());
    const [packageAccepted, setPackageAccepted] = useState(false);
    const [contactName, setContactName] = useState("DeFoor Plumbing");
    ...
    // When package accepted: seo-local and ai-marketing-suite are free; website is paid at $497
                ...
                <div style={{ maxWidth: "1060px", margin: "0 auto" }}>
                    ...
                    <div style={{ marginBottom: "40px" }}>
                        ...
                        <p style={{ fontSize: "15px", color: "rgba(255,255,255,0.50)", lineHeight: 1.65, margin: 0, maxWidth: "560px" }}>
                            Based on our conversations, we built this package to get DeFoor Plumbing ranking locally, converting visitors, and handling leads automatically — all for one flat monthly rate.
                        </p>
                    </div>
                    ...
                    <div style={{
                        ...
                        {[
                            { name: "Website", desc: "3–5 page custom site, mobile-first, SEO-optimized, online booking & service area pages", price: "$497", paid: true },
                            { name: "SEO Local", desc: "Google Business Profile setup, local keyword targeting for West Metro Atlanta & monthly rank tracking", price: "$497", freeMonthly: true },
                            { name: "AI Marketing Suite", desc: "AI voice agents, AI chat agents & AI search optimization — included at no extra cost", price: "$297", freeMonthly: true },
                        ].map((item, i, arr) => (
